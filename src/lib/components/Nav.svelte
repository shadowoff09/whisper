...
<div class="navbar bg-base-100 font-satoshi">
  ...
  {#if !data.user}
    <div class="navbar-end space-x-3">
      ...
      <a href="https://github.com/shadowoff09/whisper" target="_blank" rel="noreferrer" class="btn mr-1">
