...
<div>
	<div class="grid place-items-center mt-32">
		<h1 class="text-5xl sm:text-6xl md:text-7xl font-space-mono font-black bg-gradient-to-r bg-clip-text text-transparent 
							from-blue-500 via-purple-500 to-indigo-500
							animate-text select-none ">WHISPER</h1>
			<p class="text-white font-space-mono font-normal text-md sm:text-lg mt-10">Speak Freely, Stay Anonymous</p>
	</div>
		...
		<div class="grid place-items-center mt-32 space-y-5">
			<div class="form-control lg:w-3/5 md:w-3/4 w-full grid place-items-center">
				<input
					...
					bind:value={query} placeholder="Search for a user" name="query" id="query" type="text" required
				/>
			</div>
			<button
				type="submit"
