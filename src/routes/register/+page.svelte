...
<div class="my-24 lg:my-40 grid place-items-center">
	...
	<form action="?/register" method="POST" class="grid" use:enhance>
		...
		<div class="mb-1 space-y-1 w-56 sm:w-64 md:w-72 lg:w-96">
			<label for="password" class="text-sm font-medium text-white font-space-mono"
		...
		<button
			type="submit"
			class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-space-mono rounded-lg text-sm px-5 py-2.5 text-center mt-5 disabled:cursor-not-allowed disabled:bg-blue-500" disabled={password !== confirmPassword || password?.length < 8}
			>Register</button
		>
		<p class="mt-2 text-white text-sm font-space-mono">Have an account? <a href="/login" class="text-blue-500">Login</a></p>

		{#if form?.success === false}
			<div class="mt-4 flex items-center bg-red-500 text-white text-sm font-bold px-4 py-3 gap-2 rounded-md" role="alert">
				<svg style="color: white" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M12 6C12.5523 6 13 6.44772 13 7V13C13 13.5523 12.5523 14 12 14C11.4477 14 11 13.5523 11 13V7C11 6.44772 11.4477 6 12 6Z" fill="white"></path> <path d="M12 16C11.4477 16 11 16.4477 11 17C11 17.5523 11.4477 18 12 18C12.5523 18 13 17.5523 13 17C13 16.4477 12.5523 16 12 16Z" fill="white"></path> <path fill-rule="evenodd" clip-rule="evenodd" d="M12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2ZM4 12C4 16.4183 7.58172 20 12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4C7.58172 4 4 7.58172 4 12Z" fill="white"></path> </svg>
				<p>{form.error}</p>
			</div>
		{/if}
	</form>
